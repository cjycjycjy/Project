...
public class LoginActivity extends Activity implements OnClickListener {
	...
	public void getVersion(final Context context,final String version) {
				...
				try {
					...
					retofit.getVersion(version,
						...
						public void success(String result,
							...
							if(result.equalsIgnoreCase("success")){
							...
							else if(result.equalsIgnoreCase("check")){
								final Dialog_ApplyAdmin dialog = new Dialog_ApplyAdmin(context, "서버 점검 중입니다.");
								dialog.show();
								dialog.getBtnOk().setOnClickListener(new OnClickListener() {
								...
								final Dialog_ApplyAdmin dialog = new Dialog_ApplyAdmin(context, "버전 업데이트 바랍니다.");
								dialog.show();
								dialog.getBtnOk().setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		if (v.getId() == R.id.login_activity_LoginButton)// 占싸깍옙占쏙옙 占쏙옙占쏙옙占쏙옙
		{
			...
			new Dialog_BaseDialog(this, "서비스 준비 중입니다.").show();
