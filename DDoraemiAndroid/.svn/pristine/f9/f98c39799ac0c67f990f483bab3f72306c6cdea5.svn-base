...
public class Adapter_PopupImager_Pager extends PagerAdapter {
	Context context;
	ArrayList<ChallengePicture> url;
	AppController app;
	ImageLoader mImageLoader;
	public Adapter_PopupImager_Pager(Context context,ArrayList<ChallengePicture> url){
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		imageView.setImageUrl(app.getServerIp() + "/afterword_photo/"
				+url.get(position).getPhoto_url(), mImageLoader);
