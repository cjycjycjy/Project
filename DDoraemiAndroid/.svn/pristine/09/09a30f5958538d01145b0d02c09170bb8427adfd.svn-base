...
public class Fragment_JoinThree extends Fragment implements OnClickListener {
	...
	private void init(View v) {
		...
		address = (LinearLayout) v
				.findViewById(R.id.join_fragmentthree_addresslayout);
		city = (TextView) v.findViewById(R.id.join_fragmentthree_city);
		country = (TextView) v.findViewById(R.id.join_fragmentthree_country);
		town = (TextView) v.findViewById(R.id.join_fragmentthree_town);
	...
	public void onClick(View v) {
		...
		}else if (v.getId() == R.id.join_fragmentthree_addresslayout) {
	...
	public boolean ConfirmForNext() {
		if (isAddressSelected && selctcount>=1) {
			return true;
		}
		return false;
	}
			...
			public void run() {
				try {
					...
					final String u_phone = ((JoinActivity) getActivity())
							.getPhone();
					final char parent_gender ='M';
					final String u_gender=((JoinActivity) getActivity())
							.getChildsex();
					final int u_age=((JoinActivity) getActivity())
							.getChildage();
					final int parent_age =0;
					final String u_addr_1 = str_city;
					final String u_addr_2 = str_country;
					final String u_addr_3 = str_town;
