...
import ddoraemi.home.view.Home_MainViewChallengeListAdapter2;
...
OnItemClickListener,OnClickListener{
	...
	Home_MainViewChallengeListAdapter2 adapter;
	ImageView btn_back;
	String type="";
	TextView type_name;
	...
	public void init(){
		...
		adapter=new Home_MainViewChallengeListAdapter2(this, R.layout.item_challengelist_type, list);
