...
public class Home_MainViewChallengeListAdapter2 extends ArrayAdapter<ProgramData> {
	...
	ImageView star[];
    public Home_MainViewChallengeListAdapter2(Context context, int resource, ArrayList<ProgramData> objects) {
    ...
    public View getView(int position,View convertView, ViewGroup parent){
        ...
        if(v==null){
            ...
            v = vi.inflate(R.layout.item_challengelist_type,null);
        }
