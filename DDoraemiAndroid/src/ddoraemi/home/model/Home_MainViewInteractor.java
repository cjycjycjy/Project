...
public class Home_MainViewInteractor implements Home_MainViewInteractorInterface{
	...
	@Override
	public void getData(final String u_id, final FragmentActivity context, final OnHome_MainViewFinishedListener listener)
	{
		...
		new Thread(new Runnable() {
			public void run() {
				try {
					...
					retrofit.getProgramList_availableGroup(u_id,new Callback<JsonObject>() {
						@Override
