...
public class AfterwordReplyVo {
	...
	public AfterwordReplyVo(){}
	
	public AfterwordReplyVo(String u_id, int a_id,
			String a_r_content, int a_r_year, int a_r_month, int a_r_day) {
		super();
		this.u_id = u_id;
		this.a_id = a_id;
