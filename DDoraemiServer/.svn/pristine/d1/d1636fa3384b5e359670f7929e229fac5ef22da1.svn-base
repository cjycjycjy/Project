...
public class ProgramVo {
	...
	List<CurriculumVo> p_curriculum;
	String p_note;
	float p_grade;
	int a_id;	//�떞�떦�옄 foreign key	
	public int getP_id() {
		return p_id;
	}
	...
	public List<CurriculumVo> getP_curriculum() {
		return p_curriculum;
	}
	public void setP_curriculum(List<CurriculumVo> p_curriculum) {
