...
public class QnaDao {
	...
	public String checkReplyOfReplyUser(int q_num, int q_r_num) {
		return this.qnaMapper.checkReplyOfReplyUser(q_num, q_r_num);
	}
	...
	public void registPushListAboutReply(PushVo pushVo) {
		this.qnaMapper.registPushListAboutReply(pushVo);
	}
	public void registPushListAboutReplyOfReply(PushVo pushVo) {
		this.qnaMapper.registPushListAboutReplyOfReply(pushVo);
	}
	
	public void updatePushisChecked(int pm_num) {
		this.qnaMapper.updatePushisChecked(pm_num);
	}
	public void updateqna(int q_num, String title, String content){
		this.qnaMapper.updateqna(q_num, title, content);
	}
