...
public class GCMSender {
	...
	public <T> HashMap<String, T> sendGCM_aboutBookmarkTeamSchedule(List<ScheduleForPushMessageVo> resultVo){
		HashMap<String, T> resultHashMap = new HashMap<String, T>();
		Sender sender = new Sender(API_KEY);
		Message msg = new Message.Builder()
				.addData("type", "11")
	...
	public <T> HashMap<String, T> sendGCM_aboutRealtimeSchedule(List<RegistrationIdVo> resultVo){
		HashMap<String, T> resultHashMap = new HashMap<String, T>();
		Sender sender = new Sender(API_KEY);
		Message msg = new Message.Builder()
				.addData("type", "12")
